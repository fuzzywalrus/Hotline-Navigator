...
Defines the feature announcement system that notifies users about new capabilities, prompts for opt-in actions, and manages announcement lifecycle including persistence, migration, and sequential display.
