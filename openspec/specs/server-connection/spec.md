...
Defines the lifecycle of connecting to Hotline servers, including login handshake, disconnection, cancellation, auto-reconnect, and multi-server session management.
